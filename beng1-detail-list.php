    ...
    <div class="header">
        ...
        <nav class="breadnav">
            <ul>
                ...
                <li>
                    <a href="http://localhost/htmlcss/bengluru.php?city=<?php echo $property['city_name'];?>" class="benglurubreadcrumb"><?php echo $property['city_name'];?></a>
                </li>
                <li>
...
<?php include "includes/booking.php" ?>
    ...
    <div class="testimonials-main">
        <div class="testimonials-container">
            ...
            <?php foreach($testinomials as $testinomial){ ?>
            <div class="testimonial1">
                <div class="testi-image">
                    <img src="http://localhost/htmlcss/images/k.jpg" alt="couldn't load :(">
                </div>
                ...
                <?php
                   ...
                   ?></div>
                <div class="testi-foot">- <?php echo $testinomial['user_name'];?></div>
            </div>
