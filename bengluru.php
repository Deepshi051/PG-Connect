...
<head>
    ...
    <style>
        .bengluru-img .back {
    background: linear-gradient(rgba(255,255,255),rgba(0,0,0,0.2)),url(http://localhost/htmlcss/images/B.jpg);
            ...
            <div class="property-card row">
                ...
                <div class="property-content">
                    ...
                    <div class="rent">
                        ...
                        <div class="viewbtn">
                            <a href="beng1-detail-list.php?property_id=<?php echo $property['id'];?>">
                                <button type="button">
                                    view
                                </button>
                            </a>
